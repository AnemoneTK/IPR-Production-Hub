    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-subtle p-4 text-center">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 bg-white border border-border text-gray-700 rounded-xl hover:bg-surface-subtle transition-colors font-medium shadow-sm"
        >
